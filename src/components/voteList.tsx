                ...
                <li key={vote.id}
                    ...
                    <div className="flex min-w-0 gap-x-4 flex-1">
                        ...
                        <div className="min-w-0 flex-1">
                            ...
                            <p className="mt-1 text-xs/5 text-gray-500">{vote.description}</p>
                        </div>
                    </div>
                    <div className="shrink-0 sm:flex sm:flex-col sm:items-end mt-2 sm:mt-0">
                        {vote.vote &&
                            <div className="mt-1 flex items-center gap-x-1.5">
                                ...
                                <p className="text-xs/5 text-gray-500">Up Vote</p>
                            </div>
                        }
                        {!vote.vote &&
                            <div className="mt-1 flex items-center gap-x-1.5">
                                ...
                                <p className="text-xs/5 text-gray-500">Down Vote</p>
                            </div>
                        }
                    </div>
                </li>
